    ...
    public void create(Alumno alumno) throws Exception {
        ...
        try {
            ...
            if (findAlumno(alumno.getId()) != null) {
                throw new Exception("El alumno con ID " + alumno.getId() + " ya existe.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
        ...
        try {
            ...
            if (msg == null || msg.length() == 0) {
                ...
                if (findAlumno(id) == null) {
                    throw new NonexistentEntityException("El alumno con el ID " + id + " ya no existe.");
                }
            }
            throw ex;
        } finally {
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            try {
                ...
                throw new NonexistentEntityException("El alumno con el ID " + id + " ya no existe.", enfe);
            }
            em.remove(alumno);
            em.getTransaction().commit();
        } finally {
